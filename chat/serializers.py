...
from .models import Group, PrivateGroup, PrivateMessage
...
class PrivateMessageSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'content', 'timestamp', 'sender', 'sender_name', 'sender_avatar', 
                  'recipient', 'recipient_name', 'recipient_avatar', 'file']
...
class PrivateGroupSerializer(serializers.ModelSerializer):
    members = PrivateGroupMemberSerializer(source='members.userprofile', many=True, read_only=True)
